  ...
  var real_time = {
    onInit:function(){
      layui.use(['element','laydate','form'], function(){
        ...
        $.get(url,$.proxy(real_time.getReceiver,real_time));
        $.ajaxSettings.async = true;
        
        var receiver=$("#receiver_sort").val();
        var url="/get_real_time_data"+"?receiver="+receiver//+"&user_name="+user_name;
        $.get(url,$.proxy(real_time.getBattery,real_time));
    ...
    getBattery:function(data){
      layui.use(['element','form','layer'], function(){
        ...
        $.each(recArray,function(index,value){
          ...
          addHtml+="<legend>"+receiverName+"</legend>";
      ...
      $("img").click(function(){
        ...
        $.get(url,$.proxy(real_time.getDetail,real_time));
